...
public class EnrollFragment extends BackHandledFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        uiHandler = new UIHandler((MainActivity)getActivity());

        RequestQueue queue = Volley.newRequestQueue(getActivity());

        String url = "http://192.168.1.22:8000/enroll";
...
//                    Message msg = Message.obtain(null, Constants.MSG_ERROR);
//                    msg.setData(data);
...
//                    return;
//                }
//                Message msg = Message.obtain(null, Constants.MSG_START_ACTIVITY);
//                msg.setData(data);
//                uiHandler.sendMessage(msg);
//            }
//        });
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case Constants.MSG_ERROR:
                    data = msg.getData();
                    TextView statusText = (TextView)activity.findViewById(R.id.enroll_status_text);
                    ProgressBar progressBar = (ProgressBar)activity.findViewById(R.id.enroll_progressBar);
